...
public class GcmBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(LOG_TAG, "%%%%%%%%%%%%%%%%%%%%%%%%%%%% Sunshine GcmBroadcastReceiver msg received!");

        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
            Log.d(LOG_TAG, "%%%%%%%%%%%%%%%%%%%%%%%%%%%% Sunshine GcmBroadcastReceiver extras");
            /*
            ...
            if (GoogleCloudMessaging.MESSAGE_TYPE_MESSAGE.equals(messageType)) {
                Log.d(LOG_TAG, "%%%%%%%%%%%%%%%%%%%%%%%%%%%% Sunshine GcmBroadcastReceiver gcm");
                ...
                if (MainActivity.PROJECT_NUMBER.equals(extras.getString(EXTRA_SENDER))) {
                    Log.d(LOG_TAG, "%%%%%%%%%%%%%%%%%%%%%%%%%%%% Sunshine GcmBroadcastReceiver from");
