...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            insertWeatherDataFromJson(forecastJsonStr, locationQuery);
        } catch (IOException e) {
            ...
            e.printStackTrace();
            setConnectionStatus(getContext(), LOCATION_STATUS_SERVER_INVALID);
        } finally {
    ...
    private void insertWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                // Clean DB
                int rows = contentResolver.delete(WeatherContract.WeatherEntry.CONTENT_URI,
            ...
            setConnectionStatus(getContext(), LOCATION_STATUS_OK);
...
//                    locationSetting, System.currentTimeMillis());
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        ContentResolver contentResolver = mContext.getContentResolver();
        Cursor result = contentResolver.query(WeatherContract.LocationEntry.CONTENT_URI,
        ...
        if (result.moveToNext()) {
            int locationIdIndex = result.getColumnIndex(WeatherContract.LocationEntry._ID);
            rowID = result.getLong(locationIdIndex);
        } else {
            ContentValues inputValues = new ContentValues();
            inputValues.put(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING, locationSetting);
            inputValues.put(WeatherContract.LocationEntry.COLUMN_CITY_NAME, cityName);
            inputValues.put(WeatherContract.LocationEntry.COLUMN_COORD_LAT, lat);
            inputValues.put(WeatherContract.LocationEntry.COLUMN_COORD_LONG, lon);

            Uri insertUri = contentResolver.insert(WeatherContract.LocationEntry.CONTENT_URI,
                    inputValues);
    ...
    private void notifyWeather() {
        ...
        boolean showNotifications = prefs.getBoolean(context.getString(R.string.pref_notifications_key),
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                args.putParcelable(DetailFragment.FORECAST_URI, weatherUri);
